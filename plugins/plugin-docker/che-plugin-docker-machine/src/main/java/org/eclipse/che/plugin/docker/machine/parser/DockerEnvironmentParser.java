 ...
 */
public interface DockerEnvironmentParser extends TypeSpecificEnvironmentParser {
     ...
     */
    default String getMachineName(Environment environment) throws IllegalArgumentException {
